...
function AboutPage() {
    return (
        <div className="about-page p-16 flex flex-col items-center gap-6">
            <section className="bg-purple-100 rounded-2xl p-10 mt-28 flex flex-col items-center justify-between gap-10">
                <article className="text-center pb-10">
                    ...
                    <p className="text-2xl px-16">Welcome to Repay Smart, your one-stop solution for managing your finances.</p>
                </article>

                <article>
                    <figure>
                        <img src={AlertIcon} className="max-w-32 max-h-32 float-right w-full" alt="" />  
                    </figure>
                ...
                <article>
                    <figure>
                        <img src={PlanSvg} className="max-w-32 max-h-32 float-left mr-4 w-full" alt="" />
                    </figure>
                ...
                <article>
                    <figure>
                        <img src={CalcIcon} className="max-w-32 max-h-32 float-right w-full" alt="" />
                    </figure>
